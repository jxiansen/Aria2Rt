...
export function intoIAria2DownloadStatus(v: any): IAria2DownloadStatus {
  ...
  if (v.totalLength != undefined) o.totalLength = valueTonumber(v.totalLength);
  if (v.totalLength != undefined)
    o.completedLength = valueTonumber(v.completedLength);
  if (v.totalLength != undefined)
    o.uploadLength = valueTonumber(v.uploadLength);
  if (v.totalLength != undefined)
    o.downloadSpeed = valueTonumber(v.downloadSpeed);
  if (v.totalLength != undefined) o.uploadSpeed = valueTonumber(v.uploadSpeed);
  if (v.numSeeders != undefined) {
    o.numSeeders = valueTonumber(v.numSeeders);
  }
  if (v.seeder != undefined) {
    o.seeder = valueToBoolean(v.seeder);
  }
  if (v.totalLength != undefined) o.pieceLength = valueTonumber(v.pieceLength);
  if (v.totalLength != undefined) o.numPieces = valueTonumber(v.numPieces);
  if (v.totalLength != undefined) o.connections = valueTonumber(v.connections);
  ...
  if (v.bittorrent != undefined) {
    if (v.bittorrent.creationDate != undefined) {
      o.bittorrent.creationDate = valueTonumber(v.bittorrent.creationDate);
    }
  }
...
export function intoIAria2FileStatus(v: any): IAria2FileStatus {
  ...
  o.length = valueTonumber(v.length);
  o.completedLength = valueTonumber(v.completedLength);
...
export function intoIAria2PeersInfo(v: any): IAria2PeersInfo {
  ...
  o.seeder = valueToBoolean(v.seeder);
  o.uploadSpeed = valueTonumber(v.uploadSpeed);
  return o;
}
